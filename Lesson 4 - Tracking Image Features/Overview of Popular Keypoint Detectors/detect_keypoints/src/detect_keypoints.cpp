...
void detKeypoints1()
{
    ...
    // A python tutorial for FAST: https://docs.opencv.org/3.4/df/d0c/tutorial_py_fast.html
    // random SO post: https://stackoverflow.com/q/36749923
    cv::Ptr<cv::FastFeatureDetector> fast = cv::FastFeatureDetector::create(30);
    ...
    cv::drawKeypoints(img, fastKeypoints, visImage2, cv::Scalar::all(-1), cv::DrawMatchesFlags::DRAW_RICH_KEYPOINTS);
